...
- Commits: no `Co-Authored-By` trailer. Commit messages must include a multi-paragraph body explaining *what* was built, key design decisions, and notes on test coverage (what is tested and what is intentionally left untested). One-liner messages are not acceptable for feature commits.
